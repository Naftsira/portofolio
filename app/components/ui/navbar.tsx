...
export const NavItems = ({ items, className, onItemClick }: NavItemsProps) => {
  ...
  return (
    ...
    >
      {items.map((item, idx) => (
        <a onMouseEnter={() => setHovered(idx)} onClick={onItemClick} className="relative px-4 py-2 text-neutral-600 dark:text-neutral-300" key={`link-${idx}`} href={item.link}>
...
export const MobileNavToggle = ({ isOpen, onClick }: { isOpen: boolean; onClick: () => void }) => {
  return isOpen ? <IconX className="text-slate-200 text-6xl dark:text-white" onClick={onClick} /> : <IconMenu2 className="text-slate-200 dark:text-white" onClick={onClick} />;
};
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    ...
    dark: "bg-slate-900 border border-slate-800 hover:border-slate-600 text-white shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]",
